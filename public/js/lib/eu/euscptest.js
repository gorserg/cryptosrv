...
//var URL_XML_HTTP_PROXY_SERVICE = "http://localhost/testiit/Server/ProxyHandler.ashx";
...
function setKeyStatus(message, type) {
	...
	switch (type)
	{
		case 'error' : document.getElementById('keyStatusPanel').className = 'panel panel-danger'; break;
		case 'info' : document.getElementById('keyStatusPanel').className = 'panel panel-info'; break;
		case 'success' : document.getElementById('keyStatusPanel').className = 'panel panel-success'; break;
	}
}
